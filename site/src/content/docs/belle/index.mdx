...
This instruction specifically occurs when a division instruction is being run with the divisor being zero. It's a fairly rare error, as division operations aren't very common, but it can occur.
